...
`stinky-head[-dark].svg|.avatar.json`, `stinky.animations.json`.
...
mouth `#d97f8c` (surface decals; the open mouth in happy/wave/purr is an animated part), large black ears with a subtle
