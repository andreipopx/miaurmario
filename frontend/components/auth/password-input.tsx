    ...
    return (
      <div className="relative">
        <Input
          ...
          autoCorrect="off"
          spellCheck={false}
          className={cn(className, !hideToggle && 'pr-12')}
          {...props}
        />
        {!hideToggle && (
          <button
            ...
            className="absolute right-1.5 top-1/2 -translate-y-1/2 inline-flex h-10 w-10 items-center justify-center text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring rounded-full"
          >
