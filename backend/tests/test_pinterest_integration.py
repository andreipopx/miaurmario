...
def test_alembic_single_head_chain():
    ...
    assert script.get_heads() == ["imgview2609"]
    assert script.get_revision("imgview2609").down_revision == "wearusage2509"
    ...
    assert script.get_revision("stnkymem2309").down_revision == "srccare2609"
    assert script.get_revision("srccare2609").down_revision == "stylequiz2309"
    assert script.get_revision("stylequiz2309").down_revision == "seentips2609"
    assert script.get_revision("seentips2609").down_revision == "notif2609"
    assert script.get_revision("notif2609").down_revision == "daymoments2609"
    assert script.get_revision("daymoments2609").down_revision == "avatar2609"
    assert script.get_revision("avatar2609").down_revision == "lastfm2109"
